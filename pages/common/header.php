<!-- preloader -->
    ...
    <header class="navigation">
      <nav class="navbar navbar-expand-lg navbar-light page-container">
        <a class="navbar-brand" href="./index.php"><img class="img-fluid" src="images/logo.png" alt="parsa"></a>
        ...
        <div class="collapse navbar-collapse text-center" id="navogation">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-uppercase text-dark" href="about.html">Howllywood</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-uppercase text-dark" href="category.html">Bollywood Series</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-uppercase text-dark" href="contact.html">Howllywood Series</a>
            </li>
          </ul>
